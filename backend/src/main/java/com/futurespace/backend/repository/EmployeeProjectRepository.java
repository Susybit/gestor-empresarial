...
import com.futurespace.backend.model.entities.EmployeeProject;
import com.futurespace.backend.model.entities.EmployeeProjectId;
...
public interface EmployeeProjectRepository extends JpaRepository<EmployeeProject, EmployeeProjectId> {
     ...
     */
    @Query("SELECT new com.futurespace.backend.model.dto.AssignmentDTO(" +
            "a.project.idProject, a.employee.idEmployee, a.assignmentDate) " +
            "FROM EmployeeProject a")
    List<com.futurespace.backend.model.dto.AssignmentDTO> findAllFlat();
}
